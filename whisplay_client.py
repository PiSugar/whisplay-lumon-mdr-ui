...
DEFAULT_APP_ID = "whisplay-lumon-mdr-ui"
DEFAULT_APP_DISPLAY_NAME = "Lumon MDR"
DEFAULT_APP_ICON = "L"
DEFAULT_EXIT_GESTURE = "long_press"
DEFAULT_PRIORITY = 20
DEFAULT_USE_DAEMON_DEFAULT_LOG = True
...
class WhisplayDaemonProxy:
    ...
    def __init__(
        ...
        launch_cwd=None,
        persist=True,
        exit_gesture=DEFAULT_EXIT_GESTURE,
        priority=DEFAULT_PRIORITY,
        use_daemon_default_log=DEFAULT_USE_DAEMON_DEFAULT_LOG,
    ):
    ...
    def _send_request(self, cmd, payload=None):
    ...
    def register(self):
        payload = {
            ...
            "exit_gesture": self._exit_gesture,
            "priority": self._priority,
            "use_daemon_default_log": self._use_daemon_default_log,
        }
    ...
    def acquire_foreground(self, timeout_sec=5.0):
    ...
    def _attach_framebuffer(self, buffer_handle, stride):
...
def create_whisplay_hardware(
    ...
    if daemon.ping():
        ...
        print(f"[Whisplay] Using whisplay-daemon app_id={app_id}")
        return daemon

    print("[Whisplay] whisplay-daemon not available, using direct hardware access")
